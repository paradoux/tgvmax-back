...
function ConversationsGetter(Implementation, params, opts, collectionName) {
  ...
  if (opts.integrations.intercom.credentials) {
    ...
    intercom = new Intercom.Client(opts.integrations.intercom.appId, opts.integrations.intercom.apiKey).usePromises();
  }
  ...
  this.perform = function () {
    ...
    return Implementation.Intercom.getCustomer(model, params.recordId).then(function (customer) {
