...
exports.createCollections = function (Implementation, apimap, collectionAndFieldName) {
  ...
  pushIntoApimap(apimap, {
    ...
    fields: [{ field: 'id', type: 'String', isFilterable: false }, { field: 'title', type: 'String', isFilterable: false }, { field: 'createdAt', type: 'Date', isFilterable: false }, {
      field: 'lastMessage',
      type: 'String',
  ...
  pushIntoApimap(apimap, {
    ...
    isReadOnly: true,
    paginationType: 'cursor',
    fields: [{ field: 'id', type: 'String', isFilterable: false }, { field: 'sender', type: 'String', isFilterable: false }, { field: 'sentAt', type: 'Date', isFilterable: false }, { field: 'content', type: 'String', isFilterable: false }, { field: 'mimeType', type: 'String', isFilterable: false }],
    actions: []
  });
};
