...
exports.createCollections = function (Implementation, apimap, collectionAndFieldName) {
  ...
  pushIntoApimap(apimap, {
    ...
    fields: [{ field: 'url', type: 'String', isFilterable: false, widget: 'link' }, { field: 'display_name', type: 'String', isFilterable: false }, { field: 'status_label', type: 'String' }, { field: 'created_by_name', type: 'String', isFilterable: false }, { field: 'date_updated', type: 'Date', isFilterable: false }, { field: 'date_created', type: 'Date', isFilterable: false }, { field: 'description', type: 'String', isFilterable: false }, { field: 'emails', type: ['String'], reference: collectionName + '_closeio_emails.id' }]
  });
  ...
  pushIntoApimap(apimap, {
    ...
    isReadOnly: true,
    onlyForRelationships: true,
    fields: [{ field: 'status', type: 'String', isFilterable: false }, { field: 'sender', type: 'String', isFilterable: false }, { field: 'subject', type: 'String', isFilterable: false }, { field: 'body_text', type: 'String', isFilterable: false }]
  });
};
