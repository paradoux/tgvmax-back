...
function PaymentsGetter(Implementation, params, opts, integrationInfo) {
  ...
  this.perform = function () {
    ...
    return Implementation.Stripe.getCustomer(collectionModel, collectionFieldName, params.recordId).then(function (customer) {
      ...
      return getCharges(query).spread(function (count, payments) {
        return P.map(payments, function (payment) {
          if (customer) {
            payment.customer = customer;
          } else {
            return Implementation.Stripe.getCustomerByUserField(collectionModel, fieldName, payment.customer).then(function (customerFound) {
