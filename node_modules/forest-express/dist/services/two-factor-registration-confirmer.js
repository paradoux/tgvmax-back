...
function TwoFactorRegistrationConfirmer(_ref) {
  ...
  this.perform = function () {
    return new P(function (resolve, reject) {
      ...
      var bodyData = { useGoogleAuthentication: useGoogleAuthentication };
      ...
      request.post(forestUrl + '/liana/v2/projects/' + projectId + '/two-factor-registration-confirm').send(bodyData).set('forest-secret-key', envSecret).end(function (error) {
        if (error) {
          logger.error(error);
