...
function ResourceSerializer(Implementation, model, records, integrator, opts, meta, fieldsSearched, searchValue, fieldsPerModel) {
        ...
        if (field.integration) {
          ...
          if (_.isPlainObject(field.type)) {
            ...
            if (_.isArray(field.type) && !fieldReference && referenceSchema.isVirtual) {
              if (_.find(referenceSchema.fields, function (field) {
